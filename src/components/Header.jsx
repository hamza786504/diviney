...
function Header() {
  ...
  return (
    <>
      ...
      <div className="m-3 lg:hidden relative bg-[#F8F12F8] min-h-[40px] border-[#D6D6D9] border rounded-3xl">
        <input
          type="text"
          name=""
          id=""
        ...
        >
          ...
          >
            <path
              stroke-linecap="round"
              stroke-linejoin="round"
              d="m21 21-5.197-5.197m0 0A7.5 7.5 0 1 0 54.196 5.196a7.5 7.5 0 0 0 10.607 10.607Z"
            />
          </svg>
        </button>
      </div>
      ...
      <AuthForm
        type="signup"
        showForm={showSignUp}
        setShowForm={setShowSignUp}
      />

      <AuthForm type="login" showForm={showLogin} setShowForm={setShowLogin} />
    </>
  );
}
